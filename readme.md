...
1. Получить API TOKEN через @botfather в telegram
2. Вставить полученный токен вместо `YOUR TOKEN HERE` в файле `config.py`
3. Запустить файл `main.py`
4. Перейти в созданного telegram бота и начать пользование.

## Примечания

В качестве API для получения курсов валют был выбран бесплатный провайдер – https://api.frankfurter.dev с обновлением курсов раз в сутки.